        ...
        {running ? (
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2 justify-center max-w-md mx-auto">
              ...
              {projects.map(p => (
                <button key={p.id} onClick={() => startTimer(p.id)} className="btn-outline text-sm py-2 max-w-[160px]">
                  <svg className="w-4 h-4 inline-block mr-1 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14.752 11.168l-3.197-2.132A1 1 0 0010 9.87v4.263a1 1 0 001.555.832l3.197-2.132a1 1 0 000-1.664z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                  <span className="truncate inline-block align-middle max-w-[100px]">{p.name}</span>
                </button>
              ))}
